...
lib LibWkHtmlToImage
  ...
  fun wkhtmltoimage_destroy_converter(converter : WkhtmltoimageConverter) : Void

  fun wkhtmltoimage_set_warning_callback(converter : WkhtmltoimageConverter, cb : StrCallback) : Void
  fun wkhtmltoimage_set_error_callback(converter : WkhtmltoimageConverter, cb : StrCallback) : Void
  fun wkhtmltoimage_set_phase_changed_callback(converter : WkhtmltoimageConverter, cb : VoidCallback) : Void
  fun wkhtmltoimage_set_progress_changed_callback(converter : WkhtmltoimageConverter, cb : IntCallback) : Void
  fun wkhtmltoimage_set_finished_callback(converter : WkhtmltoimageConverter, cb : IntCallback) : Void
  ...
  fun wkhtmltoimage_get_output(converter : WkhtmltoimageConverter, output : LibC::UChar**) : LibC::Long
end
