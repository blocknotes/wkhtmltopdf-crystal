...
lib LibWkHtmlToPdf
  ...
  fun wkhtmltopdf_destroy_global_settings(settings : WkhtmltopdfGlobalSettings) : Void

  fun wkhtmltopdf_create_object_settings : WkhtmltopdfObjectSettings
  fun wkhtmltopdf_destroy_object_settings(settings : WkhtmltopdfObjectSettings) : Void
  ...
  fun wkhtmltopdf_destroy_converter(converter : WkhtmltopdfConverter) : Void

  fun wkhtmltopdf_set_warning_callback(converter : WkhtmltopdfConverter, cb : StrCallback) : Void
  fun wkhtmltopdf_set_error_callback(converter : WkhtmltopdfConverter, cb : StrCallback) : Void
  fun wkhtmltopdf_set_phase_changed_callback(converter : WkhtmltopdfConverter, cb : VoidCallback) : Void
  fun wkhtmltopdf_set_progress_changed_callback(converter : WkhtmltopdfConverter, cb : IntCallback) : Void
  fun wkhtmltopdf_set_finished_callback(converter : WkhtmltopdfConverter, cb : IntCallback) : Void

  fun wkhtmltopdf_convert(converter : WkhtmltopdfConverter) : LibC::Int
  fun wkhtmltopdf_add_object(converter : WkhtmltopdfConverter, settings : WkhtmltopdfObjectSettings, data : LibC::Char*) : Void
  ...
  fun wkhtmltopdf_get_output(converter : WkhtmltopdfConverter, output : LibC::UChar**) : LibC::Long
end
